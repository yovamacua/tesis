        ...
        <ul class="nav sidebar-menu">
          ...
          <li>
            <a href="#">
              ...
              <span class="sidebar-title">Item unico</span>
          ...
          <li class="active">
            <a href="dashboard.html">
              <span class="glyphicon glyphicon-home"></span>
              <span class="sidebar-title">Item unico (activo)</span>
            </a>
          </li>
          <li class="sidebar-label pt15">Separador</li>
          <li>
            <a class="accordion-toggle" href="#">
              <span class="fa fa-columns"></span>
              <span class="sidebar-title">Item multiple 2 niveles</span>
          ...
          <li>
            <a class="accordion-toggle" href="#">
              ...
              <span class="sidebar-title">Item 1 nivel</span>
              <span class="caret"></span>
            </a>
            <ul class="nav sub-nav">
              <li>
              ...
              <li>
                <a href="admin_plugins-modals.html">
                  <span class="glyphicon glyphicon-modal-window"></span> item </a>
              </li>
              <li>
                <a href="admin_plugins-dock.html">
                  <span class="glyphicon glyphicon-equalizer"></span> item </a>
              </li>
            </ul>
          </li>
          ...
          <!-- sidebar bullets -->
          <li class="sidebar-label pt20">Otros tipos de items</li>
          ...
          <li class="sidebar-label pt25 pb10">Item</li>

...
//objeto de tipo Incidentes
  ...
  //el parametro id_incidente se envia por AJAX cuando se edita la categoria
   ...
   $sub_array[]= ' <button type="button" onClick="eliminar('.$row["id_categoria"].');"  id="'.$row["id_categoria"].'" class="btn btn-danger btn-md hint--top" aria-label="Eliminar Perdida "><i class="fa fa-trash"></i></button></div>';
